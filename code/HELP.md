...
* The following dependencies are not known to work with Spring Native: 'Oracle Driver, MyBatis Framework, Spring Boot
  DevTools, Spring Configuration Processor'. As a result, your application may not work as expected.
...
```
$ docker run --rm -p 8080:8080 asule:0.0.1-SNAPSHOT
```
